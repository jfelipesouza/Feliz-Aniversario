...
import { duplicateRegenerateSortArray } from '../../util/card-utils'
import { Text, Grid as GridContainer } from './styles'
...
export function Grid({ cards }: GridProps) {
  ...
  return (
    <>
      ...
      <GridContainer>
        {stateCards.map(card => {
          return <GameCard {...card} key={card.id} handleClick={handleClick} />
        })}
      </GridContainer>
    </>
  )
